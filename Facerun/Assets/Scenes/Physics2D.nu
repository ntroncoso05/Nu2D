...
Entities:
  ...
  - Entity: 12837192831273
    TagComponent:
      Tag: Right wall
    TransformComponent:
      Translation: [2.66433668, -0.0355660878, 0]
      Rotation: [0, 0, 1.57079637]
      Scale: [3.19311404, 0.460553735, 1]
    SpriteRendererComponent:
      Color: [0.525490224, 0.301960796, 0.125490203, 1]
      TilingFactor: 1
    Rigidbody2DComponent:
  ...
  - Entity: 12837192831274
    TagComponent:
      Tag: Box
    TransformComponent:
      Translation: [1.10208762, 2.24763393, 0.0225157067]
  ...
  - Entity: 642903389542813379
    TagComponent:
      Tag: Left wall
    TransformComponent:
      Translation: [2.66586065, 1.80753124, 0]
      Rotation: [0, 0, 0]
    ...
    BoxCollider2DComponent:
      ...
      Restitution: 0
      RestitutionThreshold: 0.5
  - Entity: 10272925997764380651
    TagComponent:
      Tag: Text
    TransformComponent:
      Translation: [0.804331422, 6.85394239, 0]
      Rotation: [0, 0, 0]
      Scale: [1, 1, 1]
    Rigidbody2DComponent:
      BodyType: Dynamic
      FixedRotation: false
    BoxCollider2DComponent:
      Offset: [1.64999998, 0.25]
      Size: [1.70000005, 0.400000006]
      Density: 1
      Friction: 0.5
      Restitution: 0.519999981
      RestitutionThreshold: 0.5
    TextComponent:
      TextString: Nathaniel
      Color: [1, 1, 1, 1]
      Kerning: 0
      LineSpacing: 0
