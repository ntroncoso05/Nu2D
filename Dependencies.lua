...
IncludeDir["filewatch"] = "%{wks.location}/Nu/vendor/filewatch"
...
IncludeDir["msdfgen"] = "%{wks.location}/Nu/vendor/msdf-atlas-gen/msdfgen"
IncludeDir["msdf_atlas_gen"] = "%{wks.location}/Nu/vendor/msdf-atlas-gen/msdf-atlas-gen"
