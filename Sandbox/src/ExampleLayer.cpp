	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	m_ChernoLogoTexture = Nu::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(Nu::Timestep ts) 
{
	// Update
	m_CameraController.OnUpdate(ts);

	// Render
	Nu::RenderCommand::SetClearColor({ 0.1f, 0.1f, 0.1f, 1 });
...
void ExampleLayer::OnEvent(Nu::Event& e) 
{
