...
namespace Nu {
	...
	namespace Utils {
		...
		static GLenum NuImageFormatToGLDataFormat(ImageFormat format)
		{
			switch (format)
			{
		...
		static GLenum NuImageFormatToGLInternalFormat(ImageFormat format)
		{
			switch (format)
			{
		...
		: m_Specification(specification), m_Width(m_Specification.Width), m_Height(m_Specification.Height)
	{
		...
		m_InternalFormat = Utils::NuImageFormatToGLInternalFormat(m_Specification.Format);
		m_DataFormat = Utils::NuImageFormatToGLDataFormat(m_Specification.Format);
